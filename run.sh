...
CUDA_VISIBLE_DEVICES=0 python train.py  -mode nmt_char -epochs 100 -batch_size 32 -lr 0.00001 -grad_clip 1.0 -path '../data_1000k_char/' -extension '.zh .en'  -train 'train' -valid 'val' -test 'test' -embed_size 256 -hidden_size 512 -nmt_encoder_layers 2 -nmt_decoder_layers 1 -ctc_layers 2 -dropout 0.3 -nmt_result_file 'test_nmt_result.txt' -save_path 'checkpoints/charWord_zhen_exp1' -log_FileName 'checkpoints/log_exp1'  -model_cell 'LSTM' 
