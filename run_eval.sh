...
CUDA_VISIBLE_DEVICES=0 python train.py  -mode nmt_char -epochs 100 -batch_size 8 -lr 0.00001 -grad_clip 1.0 -path '../../../data/AI_chanllenger2017/data_1000k_char/' -extension '.zh .en'  -train 'train' -valid 'val' -test 'test' -embed_size 256 -hidden_size 512 -nmt_encoder_layers 2 -nmt_decoder_layers 2 -ctc_layers 2 -dropout 0.3 -nmt_result_file 'checkpoints/test_temp.txt' -val_nmt_result_file 'checkpoints/val_temp.txt' -save_path 'checkpoints/temp' -log_FileName 'checkpoints/log_temp'  -model_cell 'GRU' -tgt_dict_maxSize 50000 -model_path 'checkpoints/charWord_zhen_exp4/seq2seq_2.pt' -istest
